  ...
  return (
    <nav className="fixed w-full bg-dark-800/90 backdrop-blur-lg z-10 border-b border-dark-700">
      <div className="max-w-6xl mx-auto px-6 py-5 flex justify-between items-center">
        <a
          href="#"
          className="text-xl font-medium tracking-tight text-primary-300 hover:text-primary-400 transition-colors"
        >
        ...
        <div className="flex items-center space-x-6">
          ...
          {showEmail ? (
            <div className="flex items-center px-4 py-2">
              ...
              <a
                href="mailto:hey.sohan@gmail.com"
